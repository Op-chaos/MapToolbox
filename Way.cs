                    ...
                    case "type":
                        switch (tag.Attributes["v"].Value)
                        {
                            ...
                            case "parking_lot":
                                ...
                                break;
                            case "line_string":
                                gameObject.AddComponent<LineString>();
                                break;
                            case "ploygon":
                                gameObject.AddComponent<Ploygon>();
                                break;
        ...
        internal XmlElement Save(XmlDocument doc)
        {
            if(Valide)
            {
                ...
                if (line_thin)
                {
                    ...
                    way.AppendChild(doc.AddTag("color", line_thin.color.ToString()));
                    way.AppendChild(doc.AddTag("vir", line_thin.vir.ToString()));
                    way.AppendChild(doc.AddTag("width", line_thin.width.ToString()));
                }
                var line_string = GetComponent<LineString>();
                if (line_string)
                {
                ...
                if (traffic_light)
                {
                    ...
                    way.AppendChild(doc.AddTag("shape", traffic_light.shape.ToString()));
                    way.AppendChild(doc.AddTag("control", traffic_light.control.ToString()));
                }
