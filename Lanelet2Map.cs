...
namespace Packages.MapToolbox
{
    ...
    public class Lanelet2Map : MonoBehaviour
    {
        ...
        internal void AddLineString() => Selection.activeObject = LineString.AddNew(this);
        internal void AddPloygon() => Selection.activeObject = Ploygon.AddNew(this);
    ...
    class Lanelet2MapEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Add LineString"))
            {
                (target as Lanelet2Map).AddLineString();
            }
            if (GUILayout.Button("Add Ploygon"))
            {
                (target as Lanelet2Map).AddPloygon();
            }
            ...
            if (GUILayout.Button("Filter LineString"))
            {
                SceneModeUtility.SearchForType(typeof(LineString));
            }
            if (GUILayout.Button("Filter Ploygon"))
            {
                SceneModeUtility.SearchForType(typeof(Ploygon));
            }
